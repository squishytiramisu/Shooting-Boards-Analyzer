...
minimum_circle_size = 4      #this is the range of possible circle in pixels you want to find
maximum_circle_size = 6     #maximum possible circle size you're willing to find in pixels
